...
// $db_port = 1234;
// Database name:
$db_database = "freedb_mrbs_1";
// Schema name.  This only applies to PostgreSQL and is only necessary if you have more
// than one schema in your database and also you are using the same MRBS table names in
// multiple schemas.
//$db_schema = "public";
// Database login user name:
$db_login = "freedb_mrbs";
// Database login password:
$db_password = 'Y3gT#Eq8Unxp38S';
...
$mrbs_company = "Coop Dx Hub";   // This line must always be uncommented ($mrbs_company is used in various places)
